...
if __name__ == "__main__":
    ...
    #download_rgbd("00033")  # Save to data/rgbd/00033.zip, if available
    #download_mesh("00033")  # Save to data/mesh/00033.ply, if available
    #download_video("00033") # Save to data/video/00033.mp4, if available
    #download_all("00033")   # Downloads rgbd, mesh, and video together
